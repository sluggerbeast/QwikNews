...
function ShortCards({ src, heading, summary }) {
  return (
    <div className="flex flex-col justify-center h-[100vh] w-fit sm:w-[400px] bg-slate-100 rounded rounded-[10px] m-3 overflow-hidden font-roboto">
...
function App() {
  ...
  return (
    <>
      <div>
        <h1 className="text-center p-2 bg-slate-600 text-white fixed w-full mb-2">
          Quick News
        </h1>
      </div>
      <div>
