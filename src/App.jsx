...
function ShortCards({ src, heading, summary,taskToggle }) {
  ...
  return (
    <div onClick={handleTaskBarToggle}  className="flex flex-col justify-center h-[100vh] w-fit sm:w-[400px] bg-slate-100 rounded rounded-[10px] mb-1 overflow-hidden font-roboto">
      ...
      <div className="m-4 flex-[70%]">
        ...
        <p className="font-[300] mt-2 text-slate-900 text-[1.1rem]">{summary}</p>
      </div>
      ...
      <div class=" text-white bg-black  shadow-2xl flex-none ">
        <div
          style={{
            ...
            borderImage: `url(${src}) 25 25 round`,
          }}
        >
          <div className="w-full h-full backdrop-blur-xl p-4">
...
function App() {
  ...
  return (
    <>
      <div style={{display:showTaskBar?"block":"none"}} className="text-center p-2 bg-slate-300  fixed w-full mb-2 ">
